...
import { handleTouchScroll } from '../../../../utils/common/utils'
import './index.scss'

export default class FreshFloatLayout extends Component {
  constructor (props) {
    super(...arguments)
  ...
  render () {
    ...
    return (
      <View className={rootClass} onTouchMove={this.handleTouchMove}>
        ...
        <View className='at-float-layout__container layout' style={customStyle}>
          {title ? (
