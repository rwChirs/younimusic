...
export default class ClubRankList extends CommonPageComponent {
  constructor(props) {
    super(props);
    this.state = {
      h5_url: null,
  ...
  init = params => {
    ...
    let h5_url = encodeURIComponent(
      `${app.h5RequestHost}/club-rank-list?storeId=${params.storeId}&showNavigationBar=1&from=miniapp`
    );
    console.log('init-------------------2----------', h5_url);
