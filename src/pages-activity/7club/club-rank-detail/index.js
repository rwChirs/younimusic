...
export default class ClubRankDetail extends CommonPageComponent {
  constructor(props) {
    super(props);
    this.state = {
      h5_url: null,
  ...
  init = params => {
    ...
    let h5_url = encodeURIComponent(
      `${app.h5RequestHost}/club-rank-detail?storeId=${params.storeId}&contentId=${params.contentId}&showNavigationBar=1&from=miniapp`
    );
