...
export default class WxShare {
  ...
  share(shareData = {}) {
    ...
    shareData = { ...this.defaultShare, ...shareData };
    ...
    return Promise.resolve()
      ...
      .then(() => {
        ...
        // Above jssdk1.4
        this.wx.updateAppMessageShareData(shareData, res =>
          this.shareSuccessCallBack(res)
        );
        this.wx.updateTimelineShareData(shareData, res =>
          this.shareSuccessCallBack(res)
        );
      });
  }
